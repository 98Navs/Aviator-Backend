...
export default async function setupExpressApp() {
 ...
 //   const monitor = new SystemMonitoring(); 
    ...
    app.use(cors({ credentials: true, origin: [ 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002', 'http://localhost:5173', 'https://gamingadmin.vercel.app', 'http://localhost:1111' ] }));
