...
import { uploadMultiple } from '../project_setup/Utils.mjs';

const router = express.Router();

// POST /Route to create a new Banner
router.post('/createBanner', uploadMultiple, BannerController.createBanner);
...
router.put('/updateBannerById/:id', uploadMultiple, BannerController.updateBannerById);
